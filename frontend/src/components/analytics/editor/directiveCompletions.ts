...
const DIRECTIVES: DirectiveDef[] = [
  ...
  },
  {
    ...
    params: {
      type: ['bar', 'line', 'pie', 'area', 'grouped_bar', 'stacked_bar', 'grouped_stacked_bar', 'grouped_line'],
      group_by: 'column',
      value: 'column',
      series: 'column',
      cluster: 'column',
    ...
    paramInfo: {
      ...
      cluster: 'grouped_stacked_bar only: column for the side-by-side clusters (e.g. host); series stacks within each cluster',
