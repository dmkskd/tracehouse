...
-- @chart: type=bar labels=table values=part_count style=3d
SELECT
...
-- @chart: type=pie labels=table values=total_bytes style=3d
...
-- @chart: type=bar labels=name values=bytes_on_disk
SELECT
    name,
