...
-- @chart: type=line labels=minute values=nb_bulk_inserts style=2d
-- Source: https://clickhouse.com/blog/monitoring-troubleshooting-insert-queries-clickhouse
SELECT
    toStartOfMinute(event_time) AS minute,
...
-- @chart: type=line labels=minute values=avg_duration style=3d
-- Source: https://clickhouse.com/blog/monitoring-troubleshooting-insert-queries-clickhouse
SELECT
    toStartOfMinute(event_time) AS minute,
...
-- @chart: type=grouped_line labels=hour values=p50,p95,p99 unit=ms style=2d
-- Source: https://clickhouse.com/blog/monitoring-troubleshooting-insert-queries-clickhouse
SELECT
...
-- @chart: type=area labels=minute values=total_written_rows style=2d
-- Source: https://clickhouse.com/blog/monitoring-troubleshooting-insert-queries-clickhouse
SELECT
    toStartOfMinute(event_time) AS minute,
    sum(rows) AS total_written_rows,
