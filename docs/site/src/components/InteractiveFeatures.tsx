...
const features: Feature[] = [
  {
    title: 'Time Travel',
    description: 'Replay queries, merges, and mutations at any point in time. See what the cluster was doing and when.',
    imageUrl: '/img/bg.png',
    videoFile: 'videos/time-travel.mp4',
  },
  {
  ...
  },
  {
    ...
    imageUrl: '/img/bg.png',
    videoFile: 'videos/engine-internals.mp4',
  },
  {
    title: 'System Map',
    ...
    imageUrl: '/img/bg.png',
    videoFile: 'videos/system-map.mp4',
  },
  {
    title: 'Analytics',
    ...
    imageUrl: '/img/bg.png',
    videoFile: 'videos/analytics.mp4',
  },
  {
    ...
    imageUrl: '/img/bg.png',
    videoFile: 'videos/app-monitor.mp4',
  },
  {
